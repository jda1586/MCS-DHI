                    ...
                    <div class="col-md-6" style="padding-left:0px;float: left">
                        <div class="example">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" data-plugin="datepicker" placeholder="Start">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6" style="padding-left:0px;float: left">
                        <div class="example">
                            <div class="form-group">
                                <h4 class="example-title">Select an Item </h4>
                                <label class="sr-only" for="inputName">Items</label>
                            ...
                            <div class="form-group">
                                <h4 class="example-title">Days</h4>
                                <input type="text" class="form-control" name="price" data-plugin="TouchSpin"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" data-plugin="datepicker" placeholder="End">
                            </div>
                        </div>
                    </div>
                ...
                <div class="example" style="width: 100%">
                    <div class="example" style="margin: auto">
                        <button style="margin-left:25%;max-width:300px" type="submit" id="deposito" name="deposito"
                                class="btn btn-primary btn-block waves-effect waves-light">Save Auction
                        </button>
                    </div>
                </div>
            </div>
